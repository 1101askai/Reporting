namespace BankingReport.Migrations.DbContext
{
    ...
    /// </summary>
    /// <seealso cref="System.Data.Entity.Migrations.DbMigrationsConfiguration{BankingReport.DbContexts.DbContext}" />
    internal sealed class Configuration : DbMigrationsConfiguration<BankingReport.DbContexts.DbContext>
    {
        /// <summary>
        ...
        protected override void Seed(BankingReport.DbContexts.DbContext context)
        {
